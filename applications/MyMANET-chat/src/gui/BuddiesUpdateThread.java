...
public class BuddiesUpdateThread extends Thread {
    ...
    public BuddiesUpdateThread(UnifiedForm f, int sleepTime, String filePath) {

        fileName = filePath;
        timeout = sleepTime;
        form = f;
        PrintDebug.printDebug("Buddies update thr created", UnifiedForm.DEV_DEBUG);
    ...
    public void run() {
        ...
        while (RUN_FLAG) {
            ...
            GnsmManager gnsM = new GnsmManager(UnifiedForm.PATH_GNST, fileName);
