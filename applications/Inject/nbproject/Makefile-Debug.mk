...
.build-conf: ${BUILD_SUBPROJECTS}
	${MAKE}  -f nbproject/Makefile-Debug.mk dist/Debug/GNU-Linux-x86/inject

dist/Debug/GNU-Linux-x86/inject: ${OBJECTFILES}
...
${OBJECTDIR}/file_handling_functions.o: nbproject/Makefile-${CND_CONF}.mk file_handling_functions.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/file_handling_functions.o file_handling_functions.c
...
${OBJECTDIR}/inject.o: nbproject/Makefile-${CND_CONF}.mk inject.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/inject.o inject.c
...
.clean-conf: ${CLEAN_SUBPROJECTS}
	${RM} -r build/Debug
	${RM} dist/Debug/GNU-Linux-x86/inject
