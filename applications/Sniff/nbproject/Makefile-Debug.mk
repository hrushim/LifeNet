...
.build-conf: ${BUILD_SUBPROJECTS}
	${MAKE}  -f nbproject/Makefile-Debug.mk dist/Debug/GNU-Linux-x86/sniff

dist/Debug/GNU-Linux-x86/sniff: ${OBJECTFILES}
...
${OBJECTDIR}/socket_functions.o: nbproject/Makefile-${CND_CONF}.mk socket_functions.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/socket_functions.o socket_functions.c

${OBJECTDIR}/network_functions.o: nbproject/Makefile-${CND_CONF}.mk network_functions.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/network_functions.o network_functions.c

${OBJECTDIR}/supporting_functions.o: nbproject/Makefile-${CND_CONF}.mk supporting_functions.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/supporting_functions.o supporting_functions.c

${OBJECTDIR}/stats_log_functions.o: nbproject/Makefile-${CND_CONF}.mk stats_log_functions.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/stats_log_functions.o stats_log_functions.c

${OBJECTDIR}/display_functions.o: nbproject/Makefile-${CND_CONF}.mk display_functions.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/display_functions.o display_functions.c

${OBJECTDIR}/manifold_routing.o: nbproject/Makefile-${CND_CONF}.mk manifold_routing.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/manifold_routing.o manifold_routing.c

${OBJECTDIR}/sniff.o: nbproject/Makefile-${CND_CONF}.mk sniff.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/sniff.o sniff.c
...
.clean-conf: ${CLEAN_SUBPROJECTS}
	${RM} -r build/Debug
	${RM} dist/Debug/GNU-Linux-x86/sniff
